...
class CommentRepositoryTest {
    ...
    void findByNickname() {
        ...
        // case 2 : 'Kim' 의 모든 댓글 조회
        {
            ...
            //예상
            Comment a = new Comment(2L, new Article(4L,"당신의 인생 영화는?", "댓글 ㄱ"), nickname, "아이 엠 셈");
            ...
            //검증
            assertEquals(expected.toString(), comments.toString(), "Kim의 댓글 출력");
